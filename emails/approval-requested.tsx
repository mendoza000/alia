...
export function ApprovalRequestedEmail({
  ...
  return (
    <Html lang="es">
      ...
      <Preview>Nueva solicitud de {requestTypeLabel} para revisar</Preview>
      <Body style={body}>
        <Container style={container}>
          ...
          <Section style={content}>
            ...
            <Text style={intro}>
              {requesterName} solicitó {requestTypeLabel}.
            </Text>
            ...
            <Section style={card}>
              ...
              <Hr style={divider} />
              <Text style={cardLabel}>Solicitado por</Text>
              <Text style={cardValue}>{requesterName}</Text>
            </Section>
