...
export function AppointmentReminderEmail({
  ...
  return (
    <Html lang="es">
      ...
      <Preview>Recuerda: mañana tienes sesión con {psychologistName}</Preview>
      <Body style={body}>
        <Container style={container}>
          ...
          <Section style={content}>
            <Section style={badge}>
              <Text style={badgeText}>Recordatorio</Text>
            </Section>
            ...
            <Text style={intro}>
              Hola {patientName}, te recordamos que mañana tienes una sesión
              agendada.
            </Text>
