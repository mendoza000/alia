...
interface ApprovalDecidedEmailProps {
...
export function ApprovalDecidedEmail({
  ...
  return (
    <Html lang="es">
      ...
      <Preview>Tu solicitud de {requestTypeLabel} fue {decisionLabel}</Preview>
      <Body style={body}>
        <Container style={container}>
          ...
          <Section style={content}>
            <Heading as="h2" style={heading}>
              Solicitud {decisionLabel}
            </Heading>
            <Text style={intro}>
              Tu solicitud de {requestTypeLabel} fue {decisionLabel}.
            </Text>

            <Section style={card}>
              <Text style={cardLabel}>Detalle</Text>
              <Text style={cardValue}>{summaryLine}</Text>
              {decisionNote && (
                <>
                  <Hr style={divider} />
                  <Text style={cardLabel}>Nota</Text>
                  <Text style={cardValue}>{decisionNote}</Text>
                </>
              )}
            </Section>
...
export default ApprovalDecidedEmail;
