...
export default async function MiCalendarioAjustesPage() {
    ...
    return (
        <div className="space-y-8">
            ...
            <PageHeader
                title="Horario y plantillas"
                description="Gestiona tu horario semanal, días libres y plantillas de WhatsApp"
            />
