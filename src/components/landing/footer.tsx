		...
		<footer className="bg-primary text-primary-foreground">
			<div className="mx-auto max-w-6xl px-6 py-16 md:px-12 lg:px-20 xl:px-28 xl:py-20">
				<div className="grid gap-12 md:grid-cols-3">
					...
					<div>
						...
						<p className="mt-4 max-w-xs text-sm leading-relaxed opacity-60 xl:text-base">
							Conectamos personas con psicólogos profesionales para acompañarte
					...
					{/* Links */}
					<div>
						<p className="font-heading text-lg xl:text-xl">Enlaces</p>
					...
					{/* Contact */}
					<div>
						<p className="font-heading text-lg xl:text-xl">Contacto</p>
				...
				<div className="mt-6 flex flex-col items-center justify-between gap-4 text-xs opacity-50  xl:text-sm">
					<p>
						&copy; 2026 Alia Coaching Services LLC. Todos los derechos
						reservados.
					</p>
