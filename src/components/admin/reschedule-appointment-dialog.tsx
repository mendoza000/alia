        ...
        <Dialog open={open} onOpenChange={onOpenChange}>
            <DialogContent>
                <DialogHeader>
                    ...
                    <DialogDescription>
                        Elige la nueva fecha y hora para la sesión con{" "}
                        {psychologistName}. Se notificará por correo al
                        psicólogo y al paciente.
                    </DialogDescription>
                </DialogHeader>
                    ...
                    <div className="flex items-center gap-2 rounded-md border border-border bg-secondary/40 px-3 py-2">
                        ...
                        <div className="grid gap-0.5">
                            ...
                            <p className="text-xs text-muted-foreground">
                                Permite reagendar fuera de horario, en fechas
