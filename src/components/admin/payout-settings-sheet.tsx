...
export function PayoutSettingsSheet({
    ...
    return (
        <Sheet open={open} onOpenChange={setOpen}>
            ...
            <SheetContent
                side="right"
                className="w-full sm:min-w-lg bg-card flex h-full flex-col"
            >
                <SheetHeader>
                    ...
                    <SheetDescription>
                        Define qué porcentaje del monto cobrado se le paga a
                        cada psicólogo según el tipo de comisión elegido al
                        generar el link de pago. Los pagos ya aprobados no
