...
export function GenerateReportDialog({
    ...
    const params = new URLSearchParams({
        dateFrom,
        dateTo,
        showPending: String(showPending),
    });
    ...
    function handleSendEmail() {
        startSending(async () => {
            const result = await emailSessionsReport({
                ...
                dateTo,
                psychologistId:
                    psychologistId === ALL_PSYCHOLOGISTS
                        ? undefined
                        : psychologistId,
                showPending,
            });
        ...
        <Dialog open={open} onOpenChange={setOpen}>
            ...
            <DialogContent>
                <DialogHeader>
                    ...
                    <DialogDescription>
                        Selecciona un rango de fechas y, si lo deseas, un
                        psicólogo específico. El PDF lista las sesiones
                        confirmadas y completadas del rango, con los montos
                        convertidos a dólares, marcando cuáles están pagadas y
                        cuáles pendientes. Al enviarlo por correo, cada
                        psicólogo recibe únicamente sus propias sesiones.
                    </DialogDescription>
                </DialogHeader>
                ...
                <div className="grid gap-1.5">
                    ...
                    <Select
                        items={[
                            {
                                value: ALL_PSYCHOLOGISTS,
                                label: "Todos los psicólogos",
                            },
                            ...psychologists.map(p => ({
                                value: p.id,
                                label: p.name,
                        ...
                        onValueChange={v =>
                            setPsychologistId(v ?? ALL_PSYCHOLOGISTS)
                        }
                    >
                ...
                <div className="flex items-center gap-2">
                    ...
                    />
                    <Label htmlFor="show-pending" className="font-normal">
                        Mostrar saldo pendiente en el total
                    </Label>
                </div>
