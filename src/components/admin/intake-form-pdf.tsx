            ...
            <Page size="A4" style={styles.page}>
                <View style={styles.header}>
                    <Text style={styles.title}>
                        Formulario de Inventario de Vida
                    </Text>
                ...
                <View style={styles.meta}>
                    <View style={styles.metaItem}>
                        ...
                        <Text
                            style={{ ...styles.fieldValue, color: "#46494F" }}
                        >
                            {patientEmail}
                        </Text>
                    </View>
                ...
                <View style={styles.section}>
                    <Text style={styles.sectionTitle}>
                        2. Motivo de la sesión
                    </Text>
                    <Field
                        label="¿Por qué buscas acompañamiento?"
                ...
                <View style={styles.section}>
                    ...
                    <View style={styles.fieldGrid}>
                        ...
                        {data.previousTherapy === "Sí" && (
                            <Field
                                label="Detalles tratamiento previo"
                        ...
                        {data.currentMedication === "Sí" && (
                            <Field
                                label="Qué medicación toma"
                                value={data.currentMedicationDetails}
                            />
                        )}
                    </View>
                </View>
                ...
                <View style={styles.section}>
                    ...
                    <Field
                        ...
                        value={data.medicalHistory || "Ninguna"}
                        full
                    />
                </View>
                ...
                <View style={styles.section}>
                    <Text style={styles.sectionTitle}>
                        5. Red de apoyo / contacto de emergencia
                    </Text>
                    <View style={styles.fieldGrid}>
                        <Field
                            label="¿Con quién vive?"
                            value={data.livingWith || "No especificado"}
                        />
                        <Field
                            label="Contacto de emergencia"
                            value={data.emergencyContact || "No especificado"}
                        />
                    </View>
                </View>
                ...
                <View style={styles.section}>
                    <Text style={styles.sectionTitle}>
                        6. Expectativas del acompañamiento
                    </Text>
                    <Field
                        label="¿Qué espera lograr?"
